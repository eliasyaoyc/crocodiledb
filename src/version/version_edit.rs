...
impl VersionEdit {
    ...
    pub fn decoded_from(&mut self, src: &[u8]) -> IResult<()> {
        self.clear();
        ...
        if !msg.is_empty() {
            ...
            return Err(Error::CorruptionString(m));
        }
        Ok(())
    }
}
    ...
    fn test_encode_decode() {
        ...
        for i in 0..4 {
            ...
            edit.add_file(
                ...
                k_big + 300 + i,
                k_big + 400 + i,
                InternalKey::new("foo".as_bytes(), k_big + 500 + i, ValueType::KTypeValue),
                InternalKey::new("zoo".as_bytes(), k_big + 700 + i, ValueType::KTypeDeletion),
            );
            edit.delete_file(4, k_big + 700 + i);
            edit.add_compaction_pointer(
                i as usize,
                InternalKey::new("x".as_bytes(), k_big + 900 + i, ValueType::KTypeValue),
            );
        }
